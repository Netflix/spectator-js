...
describe("Logger Tests", (): void => {
    ...
    it("default log level is info", (): void => {
        const log1: Logger<string> = get_logger();
        ...
        const log2: Logger<string> = get_logger("x");
    ...
    it("log level filter", (): void => {
        const log: Logger<string> = get_logger("debug");
    ...
    it("write to stdout", (): void => {
        ...
        const log: Logger<string> = get_logger("warn");
        log.info("do nothing");
